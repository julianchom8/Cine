   ...
   String clave;
    public Login() {
      ...
      try {
         ...
         archivo = new File ("contraseña.txt");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ACCESO ADMINISTRDOR");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(143, 143, 143)
                        .addComponent(ingreso, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void ingresoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresoActionPerformed
     ...
     if(String.valueOf(usuario.getText()).compareTo("admin")==0 && String.valueOf(contraseña.getPassword()).compareTo(clave)==0){
            ...
            JOptionPane.showMessageDialog(null, "ERROR CONTRASEÑA O NOMBRE DE USUSARIO INCORRECTOS !!!");
